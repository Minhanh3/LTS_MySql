...
(
    khid INT NOT NULL auto_increment PRIMARY KEY,
    hoten nvarchar(50),
  	diachi nvarchar(50),
  	sdt varchar(10),
  	ghichu nvarchar(50),
...
(
	loaispid INT NOT NULL IDENTITY(1, 1) PRIMARY KEY,
 	tenloai nvarchar(50),
  	ghichu nvarchar(50),
)
GO
...
(
  	spid INT NOT NULL IDENTITY(1, 1) PRIMARY KEY,
  	loaispid int,
  	kyhieusp varchar(50),
  	tensp nvarchar(50),
  	mota nvarchar(50),
...
(
  	dondhid INT NOT NULL IDENTITY(1, 1) PRIMARY KEY,
  	khid int,
  	sohieudon int,
  	ngaydat date,
...
(
  	chitietddhid INT NOT NULL IDENTITY(1, 1) PRIMARY KEY,
  	dondhid int,
  	spid int,
  	soluong int,
