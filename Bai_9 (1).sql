...
(
    khid INT AUTO_INCREMENT NOT NULL  PRIMARY KEY,
    hoten nvarchar(50),
  	diachi nvarchar(50),
  	sdt varchar(10),
  	ghichu nvarchar(50),
...
INSERT INTO KhachHang(hoten,diachi,sdt,ghichu,email) VALUES
...
(
	loaispid INT auto_increment NOT NULL PRIMARY KEY,
 	tenloai nvarchar(50),
  	ghichu nvarchar(50)
);
INSERT INTO LoaiSanPham(tenloai,ghichu) VALUES
(N'Đồ Ăn',N'Ngon'),
(N'Đồ Uống',N'Ngon'),
(N'Trang Sức',N'Đẹp'),
(N'Quần Áo',N'Đẹp'),
...
(
  	spid INT auto_increment NOT NULL PRIMARY KEY,
  	loaispid int,
  	kyhieusp varchar(50),
  	tensp nvarchar(50),
  	mota nvarchar(50),
    nhasx nvarchar(50),
  	...
  	giaban bigint,
  	laspmoi nvarchar(50),
	FOREIGN KEY (loaispid) REFERENCES LoaiSanPham(loaispid)
);
INSERT INTO SanPham(loaispid, kyhieusp,tensp,mota,nhasx,ngaydang,giaban,laspmoi) VALUES
...
(
  	dondhid INT auto_increment NOT NULL PRIMARY KEY,
  	khid int,
  	sohieudon int,
  	ngaydat date,
...
INSERT INTO DonDatHang(khid,sohieudon,ngaydat,ngaygiotrathucte,ghichu,tinhtrang)VALUES
...
(
  	chitietddhid INT auto_increment NOT NULL PRIMARY KEY,
  	dondhid int,
  	spid int,
  	soluong int,
  	FOREIGN KEY (dondhid) REFERENCES DonDatHang(dondhid),
  	FOREIGN KEY (spid) REFERENCES SanPham(spid)
);
INSERT INTO ChiTietDonDatHang(dondhid,spid,soluong) VALUES
(1, 1, 15),
(1, 2, 11),
(1, 3, 10),
(2, 4, 120),
